...
function renderTrial(trial) {
  ...
  if (trial.brief_title_zh && trial.brief_title_zh.trim() && trial.brief_title_zh !== trial.brief_title) {
    html += '<div class="detail-title-zh">' + escapeHtml(trial.brief_title_zh) + '</div>';
  }
